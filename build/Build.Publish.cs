...
{
    [Parameter] string NuGetSource => $"https://nuget.pkg.github.com/{GitHubActions.RepositoryOwner}/index.json";
    [Parameter] [Secret] string NuGetApiKey = GitHubActions?.Token ?? "";
